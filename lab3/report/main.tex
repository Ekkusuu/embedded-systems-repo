...
% Placeholder for actual Wokwi screenshot
\begin{figure}[htbp]
\centering
\fbox{\begin{minipage}{0.85\textwidth}
\centering\vspace{3cm}
\texttt{[PLACEHOLDER -- Insert Wokwi circuit screenshot here.\\
        Open diagram.json in VS Code with Wokwi extension and take a screenshot.]}
\vspace{3cm}
\end{minipage}}
\caption{Wokwi simulation circuit (full diagram)}
...
\centering
\vspace{3cm}
{\large\texttt{[PLACEHOLDER -- Insert photo of physical hardware build here]}}\\
\vspace{0.5cm}
{\small Arduino Uno + push-button + three LEDs on breadboard}
\vspace{3cm}
\end{minipage}}
...
\texttt{[PLACEHOLDER -- Insert Wokwi simulation screenshot showing\\
        Green/Red/Yellow LEDs and the connected button mid-press.]}
\vspace{2.5cm}
\end{minipage}}
...
\centering\vspace{2.5cm}
\texttt{[PLACEHOLDER -- Insert Wokwi simulation screenshot showing\\
        Red LED illuminated after a long button press.]}
\vspace{2.5cm}
\end{minipage}}
...
\fbox{\begin{minipage}{0.85\textwidth}
\centering\vspace{2.5cm}
\texttt{[PLACEHOLDER -- Insert Wokwi serial monitor screenshot showing\\
        the 10-second statistics report printed on Serial.]}
\vspace{2.5cm}
\end{minipage}}
